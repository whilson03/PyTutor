...
class AchievementsViewHolder(private val binding: ItemAchievementsBinding) : RecyclerView.ViewHolder(binding.root) {
...
class AchievementsListAdapter : ListAdapter<AchievementItem, AchievementsViewHolder>(DIFF_CONFIG) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AchievementsViewHolder {
        val binding = ItemAchievementsBinding.inflate(LayoutInflater.from(parent.context), parent, false)
