    ...
    LessonResponse(
        ...
        lessons = mapOf(
            ...
            "5" to Tutorial(
                ...
                "",
                CodeSnippet(
                    "Sets are created with curly braces or the \"set\" keyword.",
                    "colourSet = {\"black\", \"blue\", \"red\", \"green\", \"white\"}\n" +
    ...
    LessonResponse(
        ...
        lessons = mapOf(
            ...
            "4" to com.olabode.wilson.pytutor.models.tutorial.Tutorial(
                ...
                CodeSnippet(
                    "Output",
                    "set(['blue', 'green', 'purple', 'black', 'white', 'red'])",
                    ""
                ),
                LessonTypes.CODE.ordinal
            ),
            ...
            "5" to com.olabode.wilson.pytutor.models.tutorial.Tutorial(
                ...
                "",
                CodeSnippet(
                    "Trying to add an existing value to the set does nothing.",
                    "colourSet.add(\"black\")\n" +
                        "print(colourSet)",
                    ""
                ),
            ...
            "6" to com.olabode.wilson.pytutor.models.tutorial.Tutorial(
                ...
                CodeSnippet(
                    "",
                    "set(['blue', 'green', 'purple', 'black', 'white', 'red'])",
                    "No changes made to the set values."
                ),
                LessonTypes.CODE.ordinal
            ),
            ...
            "8" to com.olabode.wilson.pytutor.models.tutorial.Tutorial(
                ...
                "",
                CodeSnippet(
                    "", "colourSet3 = colourSet.union(colourSet2)\n" +
                        "print(colourSet3)", ""
                ),
                LessonTypes.CODE.ordinal
            ),
            ...
            "9" to com.olabode.wilson.pytutor.models.tutorial.Tutorial(
                ...
                CodeSnippet(
                    "Output",
                    "set(['blue', 'brown', 'grey', 'yellow', 'purple', 'black', 'green', 'white', 'red'])",
                    "\"black\" and \"red\" aren't repeated."
                ),
                LessonTypes.CODE.ordinal
            )
        ),
    ...
    LessonResponse(
        ...
        lessons = mapOf(
            ...
            "4" to com.olabode.wilson.pytutor.models.tutorial.Tutorial(
                ...
                "",
                CodeSnippet(
                    "Frozen sets can be created with the \"frozenset\" keyword from scratch or from already existing sets.",
                    "frozenColourSet = frozenset([\"red\", \"blue\", \"green\", \"yellow\"])\n" +
            ...
            "5" to com.olabode.wilson.pytutor.models.tutorial.Tutorial(
                ...
                "",
                CodeSnippet(
                    "Adding or modifying the elements of a frozen set yields an error.",
                    "frozenColourSet.add(\"pink\")",
                    ""
                ),
                LessonTypes.CODE.ordinal
            ),
