    ...
    LessonResponse(
        ...
        lessons = mapOf(
            ...
            "8" to Tutorial(
                ...
                "",
                CodeSnippet(
                    "Take the following code:", "result = 4 > 2\n" +
                        "print(result)", ""
                ),
                LessonTypes.CODE.ordinal
            ),
            ...
            "9" to Tutorial(
                ...
                CodeSnippet(
                    "Output",
                    "True",
                    "Since 4 is indeed greater than 2, the expression was resolved to \"True\"."
                ),
                LessonTypes.CODE.ordinal
            )
        ),
    ...
    LessonResponse(
        ...
        lessons = mapOf(
            ...
            "6" to com.olabode.wilson.pytutor.models.tutorial.Tutorial(
                ...
                "",
                CodeSnippet(
                    "Now try it with a false statement.", "num1 = 4\n" +
                        "num2 = 2\n" +
                        "\n" +
                        "if num1 < num2:\n" +
                        "    print(\"num1 is greater than num2\")\n" +
            ...
            "7" to com.olabode.wilson.pytutor.models.tutorial.Tutorial(
                ...
                CodeSnippet(
                    "Output",
                    "done",
                    "The body of the if block wasn't executed because the condition is false."
                ),
                LessonTypes.CODE.ordinal
            )
        ),
    ...
    LessonResponse(
        ...
        lessons = mapOf(
            ...
            "4" to com.olabode.wilson.pytutor.models.tutorial.Tutorial(
                ...
                "",
                CodeSnippet(
                    "Output", "num1 is not greater than num2\n" +
