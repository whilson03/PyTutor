    ...
    LessonResponse(
        ...
        lessons = mapOf(
            ...
            "9" to Tutorial(
                ...
                "",
                CodeSnippet(
                    "Syntax of a Function", "def functionName(parameters[optional]):\n" +
                        "    # function", ""
                ),
    ...
    LessonResponse(
        ...
        lessons = mapOf(
            ...
            "3" to com.olabode.wilson.pytutor.models.tutorial.Tutorial(
                ...
                CodeSnippet(
                    ...
                    "name = \"John\"\n" +
                        ...
                        "print(\"Hello \" + name)\n" +
                        "print(\"How was your day?\")",
                    "This program prints a personalized greeting message for each name."
                ),
                LessonTypes.CODE.ordinal
            ),
            ...
            "6" to com.olabode.wilson.pytutor.models.tutorial.Tutorial(
                ...
                "",
                CodeSnippet(
                    "Functions make this quite easier.", "def greet(name):\n" +
                        "    print(\"Hello \" + name)\n" +
                        "    print(\"How was your day?\")\n" +
                        "\n" +
                        "greet(\"John\")\n" +
    ...
    LessonResponse(
        ...
        lessons = mapOf(
            ...
            "3" to com.olabode.wilson.pytutor.models.tutorial.Tutorial(
                ...
                "",
                CodeSnippet(
                    "Take a function to return the sum of two numbers.",
                    ...
                    "The sum of both numbers are computed and returned in the body of the function."
                ),
                LessonTypes.CODE.ordinal
            ),
            ...
            "3" to com.olabode.wilson.pytutor.models.tutorial.Tutorial(
                ...
                CodeSnippet(
                    ...
                    "def testFunc():\n" +
                        ...
                        "\n" +
                        "testFunc()",
                    "This program has a blank output as nothing is done in the function body."
                ),
                LessonTypes.CODE.ordinal
            ),
