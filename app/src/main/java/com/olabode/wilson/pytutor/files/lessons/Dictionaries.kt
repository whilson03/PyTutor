    ...
    LessonResponse(
        ...
        lessons = mapOf(
            ...
            "4" to Tutorial(
                ...
                "",
                CodeSnippet(
                    "Structure of a Dictionary", "dictTest = {\n" +
                        "    key: value,\n" +
                        "    key: value,\n" +
                        "    key: value\n" +
                        "}", ""
    ...
    LessonResponse(
        ...
        lessons = mapOf(
            ...
            "3" to com.olabode.wilson.pytutor.models.tutorial.Tutorial(
                ...
                CodeSnippet(
                    "",
                    "clientInfo = {\"firstName\": \"John\", \"lastName\": \"Doe\", \"gender\": \"Male\", \"age\": 32}",
                    ""
                ),
                LessonTypes.CODE.ordinal
            ),
    ...
    LessonResponse(
        ...
        lessons = mapOf(
            ...
            "5" to com.olabode.wilson.pytutor.models.tutorial.Tutorial(
                ...
                "",
                CodeSnippet(
                    "Output", "['lastName', 'age', 'firstName', 'gender']", ""
                ),
                LessonTypes.CODE.ordinal
            ),
            ...
            "11" to com.olabode.wilson.pytutor.models.tutorial.Tutorial(
                ...
                CodeSnippet(
                    "Output",
                    "[('lastName', 'Doe'), ('age', 32), ('firstName', 'John'), ('gender', 'Male')]",
                    ""
                ),
                LessonTypes.CODE.ordinal
            )
    ...
    LessonResponse(
        ...
        lessons = mapOf(
            ...
            "4" to com.olabode.wilson.pytutor.models.tutorial.Tutorial(
                ...
                "",
                CodeSnippet(
                    "Let's try an invalid key:",
                    "print(clientInfo.get(\"height\", 170))",
                    ""
                ),
                LessonTypes.CODE.ordinal
            ),
            ...
            "5" to com.olabode.wilson.pytutor.models.tutorial.Tutorial(
                ...
                CodeSnippet(
                    "Output",
                    "170",
                    "170 is returned because no such key called \"height\" exists in clientInfo."
                ),
                LessonTypes.CODE.ordinal
            )
        ),
    ...
    LessonResponse(
        ...
        lessons = mapOf(
            ...
            "2" to com.olabode.wilson.pytutor.models.tutorial.Tutorial(
                ...
                "",
                CodeSnippet(
                    "", "clientInfo.setdefault(\"weight\", 70)\n" +
                        "print(clientInfo)", ""
                ),
                LessonTypes.CODE.ordinal
            ),
            ...
            "3" to com.olabode.wilson.pytutor.models.tutorial.Tutorial(
                ...
                CodeSnippet(
                    "Output",
                    "{'lastName': 'Doe', 'age': 32, 'weight': 70, 'firstName': 'John', 'gender': 'Male'}",
                    "A new key \"weight\" was created with the value \"70\"."
                ),
                LessonTypes.CODE.ordinal
            ),
            ...
            "4" to com.olabode.wilson.pytutor.models.tutorial.Tutorial(
                ...
                "",
                CodeSnippet(
                    "To add or change an existing key's value, use square braces to access the key.",
                    "clientInfo[\"lastName\"] = \"Smith\"\n" +
                        "print(clientInfo)",
                    ""
                ),
                LessonTypes.CODE.ordinal
            ...
            "5" to com.olabode.wilson.pytutor.models.tutorial.Tutorial(
                ...
                CodeSnippet(
                    "Output",
                    "{'lastName': 'Smith', 'age': 32, 'weight': 70, 'firstName': 'John', 'gender': 'Male'}",
                    "lastName was changed from \"Doe\" to \"Smith\""
                ),
                LessonTypes.CODE.ordinal
            ),
